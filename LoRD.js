...
break
case 'ytvv': {
  const _0x36dec3=_0x5869;(function(_0x96bff,_0x10edd2){const _0x152e6a=_0x5869,_0x2f7545=_0x96bff();while(!![]){try{const _0x4be9d5=parseInt(_0x152e6a(0x172))/0x1+parseInt(_0x152e6a(0x177))/0x2*(-parseInt(_0x152e6a(0x17f))/0x3)+-parseInt(_0x152e6a(0x170))/0x4+parseInt(_0x152e6a(0x171))/0x5+parseInt(_0x152e6a(0x182))/0x6+parseInt(_0x152e6a(0x17e))/0x7+-parseInt(_0x152e6a(0x176))/0x8*(-parseInt(_0x152e6a(0x174))/0x9);if(_0x4be9d5===_0x10edd2)break;else _0x2f7545['push'](_0x2f7545['shift']());}catch(_0x5c828e){_0x2f7545['push'](_0x2f7545['shift']());}}}(_0x257b,0x57ce5));let {yt}=require(_0x36dec3(0x173));function _0x5869(_0x459ad6,_0xb7a9b7){const _0x257b12=_0x257b();return _0x5869=function(_0x58696e,_0x5c83df){_0x58696e=_0x58696e-0x170;let _0x106d00=_0x257b12[_0x58696e];return _0x106d00;},_0x5869(_0x459ad6,_0xb7a9b7);}if(!args||!args[0x0])throw![];let chat=global['db'][_0x36dec3(0x17d)][_0x36dec3(0x179)][m[_0x36dec3(0x178)]],quality=args[0x1]||'360',server=(args[0x2]||servers[0x0])[_0x36dec3(0x181)](),{dl_link,thumb,title,filesize,filesizeF}=await yt(args[0x0],quality+'p',_0x36dec3(0x180),quality,servers[_0x36dec3(0x17c)](server)?server:servers[0x0]),_thumb={};try{_thumb={'thumbnail':await(await fetch(thumb))['buffer']()};}catch(_0x497878){}m[_0x36dec3(0x17a)]('ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ...'),hisoka[_0x36dec3(0x17b)](m['chat'],{'video':{'url':dl_link,'caption':_0x36dec3(0x175)}},{'quoted':![]});function _0x257b(){const _0x1a91e0=['942808QmiwVW','86128OIFnQY','chat','chats','reply','sendMessage','includes','data','1031772dmjuxe','48jYfrCY','mp4','toLowerCase','1236174Zovjpv','2633208bTEumc','539340lJswci','185027lLOZHK','./lib/y2mate','81wiLeRQ','*ᴀᴍᴍᴜ-ᴍᴅ*'];_0x257b=function(){return _0x1a91e0;};return _0x257b();}
 }
            break
