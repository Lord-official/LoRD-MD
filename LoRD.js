...
break
case 'ytvv': {
  function _0x3378(_0x2c4450,_0xeb3b2c){const _0x5dde3a=_0x5dde();return _0x3378=function(_0x33788e,_0x1c1728){_0x33788e=_0x33788e-0x149;let _0x691d30=_0x5dde3a[_0x33788e];return _0x691d30;},_0x3378(_0x2c4450,_0xeb3b2c);}const _0x4630db=_0x3378;(function(_0x1a2ed1,_0x11c35a){const _0x276894=_0x3378,_0x37f1ac=_0x1a2ed1();while(!![]){try{const _0x23c1ea=-parseInt(_0x276894(0x14e))/0x1*(-parseInt(_0x276894(0x15c))/0x2)+-parseInt(_0x276894(0x153))/0x3*(-parseInt(_0x276894(0x149))/0x4)+parseInt(_0x276894(0x152))/0x5*(-parseInt(_0x276894(0x15a))/0x6)+parseInt(_0x276894(0x151))/0x7+parseInt(_0x276894(0x15f))/0x8*(parseInt(_0x276894(0x15d))/0x9)+parseInt(_0x276894(0x14c))/0xa*(-parseInt(_0x276894(0x156))/0xb)+parseInt(_0x276894(0x15b))/0xc*(parseInt(_0x276894(0x160))/0xd);if(_0x23c1ea===_0x11c35a)break;else _0x37f1ac['push'](_0x37f1ac['shift']());}catch(_0x25141a){_0x37f1ac['push'](_0x37f1ac['shift']());}}}(_0x5dde,0x1c19f));let {yt}=require(_0x4630db(0x14a)),y=fs[_0x4630db(0x14f)]('./icon2.jpeg');if(!args||!args[0x0])throw![];let chat=global['db'][_0x4630db(0x158)][_0x4630db(0x154)][m[_0x4630db(0x157)]],quality=args[0x1]||_0x4630db(0x150),server=(args[0x2]||servers[0x0])['toLowerCase'](),{dl_link,thumb,title,filesize,filesizeF}=await yt(args[0x0],quality+'p',_0x4630db(0x161),quality,servers[_0x4630db(0x15e)](server)?server:servers[0x0]),_thumb={};try{_thumb={'thumbnail':await(await fetch(thumb))[_0x4630db(0x14d)]()};}catch(_0x12a3d6){}function _0x5dde(){const _0x2b4693=['96088AdTucn','./lib/y2mate','*ᴀᴍᴍᴜ-ᴍᴅ*','10LZmlVN','buffer','24251qhlccK','readFileSync','360','45962sasvbM','20720eTzicV','6YvZrlU','chats','sendMessage','602734MEnzQF','chat','data','ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ...','222zNLkxV','539412wxDgjA','14ZjFAgS','28539kPSSTt','includes','136nhgmiN','13FAirBT','mp4'];_0x5dde=function(){return _0x2b4693;};return _0x5dde();}m['reply'](_0x4630db(0x159)),hisoka[_0x4630db(0x155)](m[_0x4630db(0x157)],{'video':{'url':dl_link,'caption':_0x4630db(0x14b)}},{'quoted':![]});
            }
            break
